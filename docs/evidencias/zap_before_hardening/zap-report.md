...
| --- | --- | --- | --- | --- |
| Info | Informational | http://127.0.0.1:8000 | Percentage of responses with status code 2xx | 33 % |
| Info | Informational | http://127.0.0.1:8000 | Percentage of responses with status code 4xx | 66 % |
| Info | Informational | http://127.0.0.1:8000 | Percentage of endpoints with content type application/json | 75 % |
| Info | Informational | http://127.0.0.1:8000 | Percentage of endpoints with content type text/html | 25 % |
| Info | Informational | http://127.0.0.1:8000 | Percentage of endpoints with method GET | 100 % |
| Info | Informational | http://127.0.0.1:8000 | Count of total endpoints | 4    |
...
* URL: http://127.0.0.1:8000/docs
  ...
  * Attack: ``
  * Evidence: `default-src 'self'; frame-ancestors 'none'`
